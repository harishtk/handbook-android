...
import com.handbook.app.feature.home.presentation.party.components.form.DisplayNameStateSaver
...
private fun ColumnScope.AddPartyFormLayout(
    ...
    val displayNameState by rememberSaveable {
        mutableStateOf(DisplayNameState(uiState.name))
    }
    val phoneNumberState by rememberSaveable {
    ...
    val addressState by rememberSaveable {
