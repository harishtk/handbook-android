...
val LightLimeGreen = Color(0xffcdfad0)
val DarkGray = Color(0xff1e2430)
val BlueGray = Color(0xff2b364a)
val DarkGreen = Color(0xFF2E7D32)
val DarkRed = Color(0xFFC62828)
val Yellow = Color(0xfffdd245)
val DarkYellow = Color(0xfffaad14)
val Purple = Color(0xff8427c8)

val LightGray = Color(0xfff0f0f0)

/* Custom colors */
val HandbookGreen = Color(0xff27ae60)
val HandbookLightGreen = Color(0xff1dd38f)
val HandbookDarkGreen = Color(0xff11512c)

val TextSecondary = Color(0xFFA0A3A8)

val LightGray200 = Color(0xffdedede)
