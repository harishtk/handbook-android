...
class AmountState(val initialValue: String = "")
    : TextFieldState(validator = ::isValidAmount, errorFor = ::errorFor), Parcelable {
...
private fun isValidAmount(amt: String): Boolean {
    return amt.isDigitsOnly() && (amt.toDoubleOrNull() ?: 0.0) in 1.0..1000000000.0
}
...
private val AmountStateSaver = textFieldStateSaver(AmountState())